...
// axios.defaults.baseURL = process.env.VUE_APP_BASE_PATH || 'http://api.app.localhost/api' // 'http://backend:3000' Backend API base URL
axios.defaults.baseURL = 'http://localhost:3000' // Backend API base URL
